...
REF_COMPONENT_ID_SERVER = 0
enums["REF_COMPONENT_ID"][0] = EnumEntry("REF_COMPONENT_ID_SERVER", """Referee server.""")
REF_COMPONENT_ID_X_FISHMONGER_A = 1
enums["REF_COMPONENT_ID"][1] = EnumEntry("REF_COMPONENT_ID_X_FISHMONGER_A", """Team X Fishmonger.""")
REF_COMPONENT_ID_X_FISHMONGER_B = 2
enums["REF_COMPONENT_ID"][2] = EnumEntry("REF_COMPONENT_ID_X_FISHMONGER_B", """Team Y Fishmonger.""")
REF_COMPONENT_ID_Y_FISHMONGER_A = 3
enums["REF_COMPONENT_ID"][3] = EnumEntry("REF_COMPONENT_ID_Y_FISHMONGER_A", """Team X Fishmonger.""")
REF_COMPONENT_ID_Y_FISHMONGER_B = 4
enums["REF_COMPONENT_ID"][4] = EnumEntry("REF_COMPONENT_ID_Y_FISHMONGER_B", """Team Y Fishmonger.""")
REF_COMPONENT_ID_FISHPOND = 5
enums["REF_COMPONENT_ID"][5] = EnumEntry("REF_COMPONENT_ID_FISHPOND", """Fish pond.""")
